...
<<<<<<< HEAD:training/distributed_training/pytorch/model_parallel_v2/shared-scripts/train_utils.py
    tflops_per_gpu = num_flops / (
                 step_time * 10**12 * world_size)
=======
    tflops_per_gpu = num_flops / (step_time * 10**12 * world_size)

>>>>>>> origin:      build_and_train_models/sm-distributed_model_parallel_v2/shared-scripts/train_utils.py
